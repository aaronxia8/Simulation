...
df1 <- data.frame("Length" = c(x1,x1,x1,x1), "Value" = c(meany[3:1000],s2[3:1000],s3[3:1000],s4[3:1000]),"Type"=c(rep("Simulation",998),rep("log2(n)",998),rep("log2(0.5n)",998),rep("E(L(n)) by FS",998)))
...
df1 <- data.frame("Length" = c(x1,x1), "Value" = c(sump[3:1000],meany[3:1000]),"Type"=c(rep("Our estimation",998),rep("Simulation",998)))
d <- ggplot(df1, aes(Length, Value))
d  + geom_point(aes(colour = Type),size=1,alpha=0.8,position=position_jitter(h=0.1, w=0.1)) +  xlab("Number of trials n") + ylab("Expected value of L(A,n) in simulations ")+ theme_grey(base_size = 24)+ theme(legend.position = c(0.8, 0.2))
...
d <- ggplot(df1, aes(Length, Value))
d  + geom_point(aes(colour = Type),size=1,alpha=0.8,position=position_jitter(h=0.1, w=0.1)) +  xlab("Number of trials n") + ylab("Expected value of L(PT,n) in simulations ")+ theme_grey(base_size = 24)+ theme(legend.position = c(0.8, 0.2))
